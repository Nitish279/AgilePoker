  ...
  return (
    <div>
        ...
        <div
          className={`card cursor-pointer ${
            selectedType === "fibonacci"
              ? "border-solid border-8 border-fuchsia-500"
              : ""
          }`}
      ...
      <div className="flex flex-wrap justify-center mt-8 gap-4">
        <a
          className="block w-full px-6 py-3 text-lg font-medium cursor-pointer text-blue-600 rounded shadow sm:w-auto hover:text-blue-400 transition-all active:text-blue-500 focus:outline-none focus:ring"
